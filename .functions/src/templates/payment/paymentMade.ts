const paymentMadeMsgTemplate = ( username:string, taskDesc:string, amount:number, tasker_username:string ) => `
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
                  ...
                  <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 12px 0px 0px 12px;">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 12px 0px 0px 12px;">
                            <h1 style="margin: 0 0 0px; font-size: 24px; font-weight: 700; line-height: 48px;">You Just got paid for a Task!</h1>
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 12px;">
                            <p>Hi ${username} you just got paid for a task by ${tasker_username}</p>
                             <h3 style="width:600px; max-width:85vw; font-size:24px; font-weight:700">task description:</p>
                          </td>
                        </tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 0px 12px;">
                             <h3 style="width:600px; max-width:85vw; font-size:24px; font-weight:700">Amount:</p>
                          </td>
                        </tr>

                        <tr style="margin: 12px;">
                          <td align="left" bgcolor="#000" color="#ffffff" style="border-radius: 6px; padding: 12px; color:#ffffff">${amount}</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
...
export const paymentMadeMsg = (email:string, username:string, taskDesc:string, amount:number, tasker_username:string ) => {
  return {
      to: [{email: email, name: username}],
      from: {email: "support@taaskly.xyz", name: "Taaskly"},
      subject: "You Just got paid for a Task!",
      message_body: {
        type: "text/html",
        value: paymentMadeMsgTemplate(username, taskDesc, amount, tasker_username),
      },
};
};
