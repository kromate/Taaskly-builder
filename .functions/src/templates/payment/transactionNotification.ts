                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 12px 0px 0px 0px;">
                            <h1 style="margin: 0 0 0px; font-size: 24px; font-weight: 700; line-height: 24px;">Transaction Notification</h1>
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 12px 0px;">
                            <p>
                              Hi ${username}, <br />
                              Your wallet got ${transaction_type} with <b>${convertToCurrency(amount)}</b>
                            </p>
                          </td>
                        </tr>
...
export const transactionNotificationtMsg = (email:string, username:string, transaction_type:string, amount:number) => {
  return {
