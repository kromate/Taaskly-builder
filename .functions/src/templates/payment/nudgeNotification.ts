...
const transactionNotificationMsgTemplate = (username: string, sendername: string) => `
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 12px 0px 0px 0px;">
                            <h1 style="margin: 0 0 0px; font-size: 24px; font-weight: 700; line-height: 24px;">Escrow Nudge Notification</h1>
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" bgcolor="#fff" color="#ffffff" style="border-radius: 6px; padding: 12px 0px;">
                            <p>
                              Hi ${username}, <br />
                              @${sendername} just send a Nudge request for you to approve their Escrow payment
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td align="left" bgcolor="#ffffff" style="padding: 20px 0px;">
                            <table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" bgcolor="#000000" style="border-radius: 6px;">
                                  <a href="https://taaskly.xyz/main/wallet?q=Escrow" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 16px 36px; font-family: 'Nunito', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Approve Payment</a>
                                </td>
                              </tr>
                            </table>
                          </td>
...
export const escrowNudgeMsg = (email:string, username:string, sendername:string) => {
  return {
      to: [{email: email, name: username}],
      from: {email: "support@taaskly.xyz", name: "Taaskly"},
      subject: "Escrow Nudge Notification",
      message_body: {
        type: "text/html",
        value: transactionNotificationMsgTemplate(username, sendername),
      },
};
};
