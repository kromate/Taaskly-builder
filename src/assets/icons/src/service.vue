<template>
	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path
			...
			stroke="currentColor" stroke-width="1.5" fill-opacity="0" stroke-linecap="round" stroke-linejoin="round" />
		<path d="M8.49597 5.32949V4.95849C8.49597 3.73849 9.48397 2.75049 10.704 2.75049H13.286C14.505 2.75049 15.494 3.73849 15.494 4.95849L15.495 5.32949" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
		<path d="M11.995 16.6782V15.3842" stroke="currentColor" fill-opacity="0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
		<path fill-rule="evenodd" clip-rule="evenodd"
			...
			stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill-opacity="0" stroke-linejoin="round" />
	</svg>
</template>
